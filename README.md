# 资源集 · Agent Community Resources

> 智能体应用兴趣学习社区（QQ 频道试点）的可复用资源集合：提示词 / Skill 开源合集。
> 原计划用 GitHub Star Lists 做分组，但该账号 API 未开放，故以策展仓库形式沉淀，便于社区共享与版本化。

## 一、工程向 skill 汇总（贴近 mattpocock/skills）
- [heilcheng/awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills) — 社区策展 Agent Skills 目录，真实可用、多 agent 兼容
- [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) — 1000+ 生产级 Claude Skills/Plugins
- [travisvn/awesome-claude-skills](https://github.com/travisvn/awesome-claude-skills) — 精选 Claude Skills/资源/工具
- [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) — 最全 Claude Code 资源秀
...
- [tallesborges/agentic-system-prompts](https://github.com/tallesborges/agentic-system-prompts) — 生产级 system prompts + tool 定义
- [langgptai/awesome-claude-prompts](https://github.com/langgptai/awesome-claude-prompts) — Claude 提示词策展

## 三、GPT-prompts 类纯提示词合集（本次新增 · 已 star）
- [f/prompts.chat](https://github.com/f/prompts.chat)（f.k.a. Awesome ChatGPT Prompts）— 社区共建提示词大全
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) — ChatGPT 中文调教指南
- [linexjlin/GPTs](https://github.com/linexjlin/GPTs) — 各 GPTs 提示词合集
- [langgptai/LangGPT](https://github.com/langgptai/LangGPT) — 结构化提示词方法论
